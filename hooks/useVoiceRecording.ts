...
export function useVoiceRecording(
  onTranscriptionComplete: ((text: string | null) => void) | undefined,
  setIsVoiceProcessing: (processing: boolean) => void
) {
  ...
  const inactivityFallbackTimer = useRef<NodeJS.Timeout | null>(null);
