...
export default function Collections() {
  ...
  return (
    <section className="relative pt-16 pb-24 mx-auto bg-gradient-to-b from-jacarta-700 to-black ">
        ...
        <div className="w-full mt-6 ">
          <div className="w-full js-collections-content">
            ...
            <div className="tab-content">
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-6 justify-center sm:justify-start">
                  {stories.length === 0 && (
                    <div className="flex flex-col items-center justify-center p-6 border border-dashed border-jacarta-100 dark:border-jacarta-600 rounded-lg text-center dark:bg-gray-800 bg-gray-100">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  {stories?.map((story, i) => (
                    ...
                    >
                      <div className="relative h-[350px] md:h-[400px] lg:h-[450px]">
                        ...
                        <span className="absolute bottom-3 left-3 text-gray-300 text-xs bg-black/50 px-2 py-1 rounded">
                          Last interaction:{" "}
                          {new Date(story.last_interaction).toLocaleString()}
                        </span>
                      </div>
