...
export default function BuyPointsModal() {
  ...
  return (
    <div
      ...
      aria-hidden="true"
    >
      <div className="modal-dialog max-w-full sm:max-w-2xl">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title text-xl sm:text-2xl font-display font-semibold text-jacarta-700 dark:text-white" id="buyPointsModalLabel">
              Buy Game Points
            </h5>
            <button
              type="button"
          ...
          <div className="modal-body p-4 sm:p-8">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              {pointsOptions.map((option, index) => (
                <div
                  ...
                  className={`cursor-pointer rounded-2xl border-2 p-4 sm:p-6 transition-all hover:shadow-lg hover:transform hover:scale-[1.02]
                    ${selectedOption?.points === option.points 
                      ? 'border-accent bg-accent/10' 
                      : 'border-jacarta-100 dark:border-jacarta-600 hover:border-accent/50'}`}
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="text-lg sm:text-2xl font-bold text-jacarta-700 dark:text-white">
                      {option.points} GP
                    </div>
                    <div className="text-md sm:text-lg font-semibold text-accent">
              ...
              <div
                ...
                className={`cursor-pointer rounded-2xl border-2 p-4 sm:p-6 transition-all hover:shadow-lg hover:transform hover:scale-[1.02] sm:col-span-2
          ...
          <div className="modal-footer border-t border-jacarta-100 dark:border-jacarta-600 p-4 sm:p-6">
            <div className="flex items-center justify-center">
              <button
                type="button"
                onClick={handlePurchase}
                disabled={!selectedOption}
                className={`rounded-full py-3 px-6 sm:py-4 sm:px-10 text-center font-semibold text-white shadow-accent-volume transition-all
                  ${selectedOption 
