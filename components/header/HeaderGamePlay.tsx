...
export default function Header({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <>
      ...
      >
        <div className="flex relative items-center px-6 py-6 xl:px-24">
          {/* Sidebar Toggle Button */}
          <div className="relative group">
            <button
              className="absolute -bottom-20 z-[1000] flex items-center justify-center rounded-full bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-500 shadow-xl border-0 transition-all duration-200 hover:scale-105 hover:from-purple-700 hover:to-blue-600  focus:outline-none focus:ring-2 focus:ring-blue-400"
              onClick={() => setSidebarOpen(!sidebarOpen)}
              aria-label={sidebarOpen ? "Close inventory" : "Open inventory"}
              type="button"
            >
              {/* {sidebarOpen ? (
                <></>
                ...
                <span className="lg:hidden">
                  <PiBackpackDuotone className="h-10 w-10 lg:hidden p-2 text-white"/>
                </span>
              )} */}
            </button>
            {/* Tooltip for open inventory */}
            {!sidebarOpen && (
              <div className="pointer-events-none absolute left-1/2 -translate-x-1/2 -bottom-16 z-[1000] opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                <div className="px-3 py-2 bg-black/90 text-white text-xs font-medium rounded-lg shadow-xl whitespace-nowrap">
                  Open Inventory
          ...
          {/* Menu / Actions */}
          <div className="js-mobile-menu invisible lg:visible fixed inset-0 z-[1000] ml-auto items-center bg-white opacity-0 dark:bg-jacarta-800 lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent ">
