...
const useResponsiveImage = (imageData, fallbackUrl = '/img/blog/default_image.jpg') => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (!selectedSize) {
        const firstAvailable = Object.values(availableSizes).find(size => size !== null);
        selectedSize = firstAvailable || { url: fallbackUrl };
      }
